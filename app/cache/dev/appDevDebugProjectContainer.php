...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'user', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\MyApp\\UserBundle\\Entity'))), 'MyApp\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('MyAppUserBundle' => 'MyApp\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_67508e87719395d15923e953d2bafdc683f1872580ab2babc16f4a208b784bed');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/affichage');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/comite/');
        ...
        $m->add($k, array(0 => 'ROLE_CLIENT'), NULL);
        $m->add($l, array(0 => 'ROLE_COMITE'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('aymen.hosni91@gmail.com');
        $a->setPassword(22884189);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CLIENT' => array(0 => 'ROLE_USER'), 'ROLE_AGENT' => array(0 => 'ROLE_USER'), 'ROLE_COMITE' => array(0 => 'ROLE_COMITE'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('product_image' => array('uri_prefix' => '/cvpdf', 'upload_destination' => ($this->targetDirs[2].'/../web/cvpdf'), 'namer' => NULL, 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => false, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'aymen.hosni91@gmail.com',
            'mailer_password' => 22884189,
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'aymen.hosni91@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 22884189,
            ...
            'vich_uploader.mappings' => array(
                'product_image' => array(
                    'uri_prefix' => '/cvpdf',
                    'upload_destination' => ($this->targetDirs[2].'/../web/cvpdf'),
                    'namer' => NULL,
